            ...
            <div class="panel panel-teal panel-widget">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        ...
                        ?>
                        <div class="large" style="font-size: 3rem;">Tổng học sinh: <?php echo $tong_hs = mysqli_num_rows($query_hocsinh); ?></div>
            ...
            <div class="panel panel-teal panel-widget">
                <div class="row no-padding">
                    ...
                    <div class="col-sm-9 col-lg-7 widget-right">
                        ...
                        ?>
                        <div class="large" style="align-items: center;">Tổng giáo viên: <?php echo mysqli_num_rows($query_giaovien); ?></div>
